...
os.environ["SERVER_NAME"] = "ServerB"
os.environ["SERVER_IP"] = "127.0.0.1"
os.environ["TCP_PORT"] = "5060"
os.environ["UDP_PORT"] = "5061"
os.environ["OTHER_SERVER_NAME"] = "ServerA"
os.environ["OTHER_SERVER_IP"] = "127.0.0.1"
os.environ["OTHER_SERVER_TCP_PORT"] = "5050"
os.environ["OTHER_SERVER_UDP_PORT"] = "5051"
...
def main():
    ...
    log("Server B TCP and UDP servers are running.")
    ...
    try:
        while True:
            ...
            if not tcp_thread.is_alive():
                log("Server B TCP thread stopped.")
                break

            if not udp_thread.is_alive():
                log("Server B UDP thread stopped.")
                break
